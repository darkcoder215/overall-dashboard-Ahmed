...
export const STATIC_TOOLS = [
  ...
  {
    slug: 'cv-analysis',
    name_ar: 'تحليل المرشحين',
    name_en: 'CV & Video Analysis',
    description_ar: 'تحليل السير الذاتية ومقاطع الفيديو التعريفية للمرشحين بالذكاء الاصطناعي مع تقييم شامل ومتعدد الأبعاد.',
    category: 'hr',
    icon: 'user-search',
    url: '/cv-analysis/',
    enabled: true,
